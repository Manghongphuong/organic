                    ...
                    <tbody>
                      @foreach ( $catenew as $cate)
                        <tr>
                          ...
                          <td>{{$cate->name}}</td>
                          <td>
                            <a href="{{route('cateblogs.edit', $cate->id)}}"><button style="width: 100px" class="btn btn-primary">Sửa</button></a>
                            <form action="{{route('cateblogs.destroy', $cate->id)}}" method="post">
                              @csrf
                              @method('DELETE')
